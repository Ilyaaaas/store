...
export function typeIcons(ttp, sizeImg = 24, color = "black") {
    switch (ttp) {
    case "image/jpg":
        return <Entypo name="image" size={sizeImg} color={color} />;
    case "image/jpeg":
        return <Entypo name="image" size={sizeImg} color={color} />;
    case "image/png":
        return <Entypo name="image" size={sizeImg} color={sizeImg} />;
    case "application/pdf":
        return <AntDesign name="pdffile1" size={sizeImg} color={sizeImg} />;
    default:
        return <AntDesign name="save" size={sizeImg} color={sizeImg} />;
    }
}
